  ...
  <div class="main-content">
    ...
    <div class="about-container">
      <div class="about-image">
        <img src="images/rfid.jpg" alt="About the system">
      </div>
      <div class="about-text">
        <h2>About the RFID Attendance System</h2>
        <p>
          This system is designed to make tracking student attendance faster and more accurate using RFID technology.
          Each student is issued an RFID card, which they tap to record time-in and time-out automatically.
          Teachers and admins can view and manage attendance records through a secure dashboard.
          The system also allows manual entry of RFID codes and provides support for photo identification.
        </p>
      </div>
    </div>
  </div>
