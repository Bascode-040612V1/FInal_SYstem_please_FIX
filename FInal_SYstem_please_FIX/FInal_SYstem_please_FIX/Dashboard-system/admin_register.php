...
require_once 'security_helpers.php'; // For validateRFID() function
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate RFID (exactly 10 alphanumeric characters)
    if (!validateRFID($rfid)) {
        $response['message'] = "RFID must be exactly 10 alphanumeric characters (letters and numbers).";
    } else {
...
<div class="container">
    ...
    <p class="instruction">Scan or enter the 10-character admin RFID (letters and numbers)</p>
